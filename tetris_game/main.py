...
pygame.display.set_caption('Yusufs Tetris Game')
                ...
                for i in range(4):
                    for j in range(4):
                        ...
                        if p in game.figure.image():
                            pygame.draw.rect(screen,colours[game.figure.colour],[game.x + game.zoom * (j +game.figure.x) +1,game.y + game.zoom * (i+game.figure.y)+1,game.zoom-2,game.zoom-2])
